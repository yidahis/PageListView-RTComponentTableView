...
@implementation TestListBaseViewCell
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.tableView registerClass:[TestListBaseViewCell class] forCellReuseIdentifier:@"cell"];
        ...
        if (self.isNeedHeader) {
            ...
            dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                ...
                if (self.dataSource.count >= 10) {
                    ...
                    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
                        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                            [weakSelf.dataSource addObject:@"加载更多成功加载更多成功加载更多成功加载更多成功加载更多成功加载更多成功加载更多成功加载更多成功加载更多成功加载更多成功"];
